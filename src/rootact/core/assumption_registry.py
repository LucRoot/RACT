...
from rootact.core.assumption import (
    Assumed,
    Assumption,
    AssumptionId,
    AssumptionState,
...
class AssumptionRegistry:
    ...
    def propose(self, text: str, depends_on: tuple[AssumptionId, ...] = ()) -> Assumption:
    ...
    def violate(self, assumption_id: AssumptionId, violation: Violation) -> list[AssumptionId]:
