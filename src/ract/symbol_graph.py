...
class SymbolGraph:
    ...
    def __init__(self, project_dir: Path) -> None:
        ...
        # e.g. project_dir "ract-work" with "src/ract/__init__.py" ->
        # package_root "src/ract", package_name "ract".
    ...
    def _is_project_import(self, target_module: str) -> bool:
        ...
        imports (``ract.providers.router``) and relative imports
        (``providers.router`` from inside ``ract``) are accepted.
        """
        ...
        if self._package_name is not None:
            ...
            # ``src/ract`` when the package root is detected there).
