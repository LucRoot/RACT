...
class WebSearchAdapter(RetrievalAdapter):
    ...
    Example::
        ...
        from ract.retrieval_adapter import WebSearchAdapter
    ...
    def search(self, query: str, top_k: int = 5) -> Rooted[list[RetrievalResult]]:
        ...
        if not self.api_key:
            return Rooted(
                ...
                error="Web search adapter requires an api_key. Configure retrieval.api_key in ract.yaml.",
            )
