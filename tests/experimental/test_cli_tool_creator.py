...
def test_create_cli_tool():
    tool_description = {
        ...
        "description": "A data analyst describes a small CLI they need; RootAct generates a Python script, argparse wiring, and a minimal test harness.",
    ...
    assert tool["description"] == "A data analyst describes a small CLI they need; RootAct generates a Python script, argparse wiring, and a minimal test harness."
