...
| **18. Use Case: Documentation Generation from Code** | `doc_generator.py`, `cli.py` | ✅ | `rootact docs generate [--output-dir <dir>]` scans the project, extracts module/class/function docstrings and signatures, and writes Markdown API docs to `docs/api`. |
