...
The harness is the primary integration surface and is covered by end-to-end CLI and unit tests. See `docs/ARCHITECTURE.md` for the system boundaries and contracts.
