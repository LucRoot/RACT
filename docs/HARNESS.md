...
The harness is the primary integration surface and is covered by end-to-end CLI and unit tests. See `docs/ARCHITECTURE.md` for the full module map and `docs/internal/AUDIT.md` for the latest verification numbers.
